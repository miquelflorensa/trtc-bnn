"""
Plot comparison results: MM-Softmax vs MC-Softmax over training epochs.
...
def plot_mae_comparison(history: dict, save_path: str = None):
    ...
    plt.suptitle('MM-Softmax vs MC-Softmax: Mean Absolute Error over Training',
...
def main(results_path: str, output_dir: str = None):
    ...
    plot_mae_comparison(
        history, 
        save_path=str(Path(output_dir) / "mae_comparison_softmax.pdf")
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Plot MM-Softmax vs MC-Softmax comparison results"
    )
    parser.add_argument("--results", type=str, 
                        default="./results/method_comparison/mm_softmax_comparison.npz",
